...
class Transformer(nn.Module):
    def __init__(self, config):
        ...
        self.cond_preprocess = MLP(input_dim, n_hidden * 2, n_hidden, n_layers=0, res=False, act=act)
        self.noise_preprocess = MLP(out_dim, n_hidden * 2, n_hidden, n_layers=0, res=False, act=act)
